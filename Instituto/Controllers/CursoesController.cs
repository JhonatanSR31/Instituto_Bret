...
namespace Instituto.Controllers
{
    public class CursoesController : Controller
    {
        ...
        public CursoesController(db_senatiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cursos != null ? 
                          ...
                          Problem("Entity set 'db_senatiContext.Cursos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'db_senatiContext.Cursos'  is null.");
            }
            var curso = await _context.Cursos.FindAsync(id);
            if (curso != null)
            {
