...
{
    public partial class db_senatiContext : DbContext
    {
        public db_senatiContext()
        {
        }

        public db_senatiContext(DbContextOptions<db_senatiContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server=edemirsenati.database.windows.net; database=db_senati; User ID=Edemir; Password=Rafaile1*;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Bloque>(entity =>
            {
                entity.HasKey(e => e.IdBloque)
                    .HasName("PK__Bloques__6B0639437AFC40BE");
            ...
            modelBuilder.Entity<Curso>(entity =>
            {
                entity.HasKey(e => e.IdCurso)
                    .HasName("PK__Cursos__DC72196F78304BCA");
            ...
            modelBuilder.Entity<Estudiante>(entity =>
            {
                entity.HasKey(e => e.IdEstudiante)
                    .HasName("PK__Estudian__9B410A89956DDB0F");
            ...
            modelBuilder.Entity<Matricula>(entity =>
            {
                entity.HasKey(e => e.IdMatricula)
                    .HasName("PK__Matricul__230086D7349686D9");
            ...
            modelBuilder.Entity<Profesore>(entity =>
            {
                entity.HasKey(e => e.IdProfesor)
                    .HasName("PK__Profesor__4D3751F667A608A4");
            ...
            modelBuilder.Entity<Programa>(entity =>
            {
                entity.HasKey(e => e.IdPrograma)
                    .HasName("PK__Programa__9DB8D163F4A809A2");
